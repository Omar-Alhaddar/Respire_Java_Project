...
<html lang="en">
    ...
    <head>
        ...
        <title>Create Event/Concert</title>
   ...
   body{
background-image:linear-gradient(rgba(47, 23, 15, 0.65), rgba(47, 23, 15, 0.65)), url("../assets/img/bg6.jpg")
}
      html, body {
      min-height: 100%;
      }
             ...
             <a href="/home">   <img   src="assets/img/project_logo.png" alt="Here is an inage" > </a>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <h2 style= "color:white">Create new Event/Concert</h2>
